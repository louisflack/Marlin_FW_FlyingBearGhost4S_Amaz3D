...
#define AUTOTEMP
  ...
  #define AUTOTEMP_MIN          210 //MODIFICATO, aggiunto 
  #define AUTOTEMP_MAX          250 //MODIFICATO, aggiunto 
  #define AUTOTEMP_FACTOR       0.1f //MODIFICATO, aggiunto 
 ...
 */
#define E0_AUTO_FAN_PIN FAN1_PIN //MODIFICATO 
...
#define QUICK_HOME                          // If G28 contains XY do a diagonal move first MODIFICATO, uncommented 
 ...
 */
#define INPUT_SHAPING_X //MODIFICATO, uncommented 
#define INPUT_SHAPING_Y //MODIFICATO, uncommented 
...
// LCD Print Progress options. Multiple times may be displayed in turn.
   ...
   * point in the file.
   */
  #define POWER_LOSS_RECOVERY //MODIFICATO
  #if ENABLED(POWER_LOSS_RECOVERY)
    #define PLR_ENABLED_DEFAULT   true // Power Loss Recovery enabled by default. (Set with 'M413 Sn' & M500) MODIFICATO 
 ...
 */
#define BABYSTEPPING //MODIFICATO, uncommented 
#if ENABLED(BABYSTEPPING)
  //#define INTEGRATED_BABYSTEPPING         // EXPERIMENTAL integration of babystepping into the Stepper ISR
  //#define BABYSTEP_WITHOUT_HOMING
  #define BABYSTEP_ALWAYS_AVAILABLE       // Allow babystepping at all times (not just during movement) MODIFICATO, uncommented 
  //#define BABYSTEP_XY                     // Also enable X/Y Babystepping. Not supported on DELTA!
  #define BABYSTEP_INVERT_Z false           // Change if Z babysteps should go the other way
  #define BABYSTEP_MILLIMETER_UNITS       // Specify BABYSTEP_MULTIPLICATOR_(XY|Z) in mm instead of micro-steps MODIFICATO, uncommented 
  #define BABYSTEP_MULTIPLICATOR_Z  0.01       // (steps or mm) Steps or millimeter distance for each Z babystep MODIFICATO da 1
 ...
 */
#define LIN_ADVANCE //MODIFICATO, uncommented   
 ...
 */
#define EMERGENCY_PARSER //MODIFICATO, uncommented 
 ...
 */
#define FWRETRACT //MODIFICATO, uncommented 
 ...
 */
#define HOST_ACTION_COMMANDS //MODIFICATO, uncommented 
 ...
 */
#define CANCEL_OBJECTS //MODIFICATO, uncommented 
