...
#define STRING_CONFIG_H_AUTHOR "(Luigi Flaccomio, Amaz3d config)" // Who made the changes.
...
#ifndef MOTHERBOARD
  #define MOTHERBOARD BOARD_MKS_ROBIN_NANO //MODIFICATO 
#endif
 ...
 * :[-1, 0, 1, 2, 3, 4, 5, 6, 7]
 */
#define SERIAL_PORT 3 //MODIFICATO
...
#define CUSTOM_MACHINE_NAME "FlyingBear Ghost 4S" //MODIFICATO
 ...
 */
#define X_DRIVER_TYPE  TMC2209_STANDALONE //MODIFICATO
#define Y_DRIVER_TYPE  TMC2209_STANDALONE //MODIFICATO
#define Z_DRIVER_TYPE  TMC2209_STANDALONE //MODIFICATO
...
#define E0_DRIVER_TYPE TMC2209_STANDALONE //MODIFICATO
...
#define BED_MAXTEMP      120 //MODIFICATO DA 150 
...
#define PID_K1     0.95   // Smoothing factor within any PID loop
  ...
  #else
    #define DEFAULT_Kp  12.70 //MODIFICATO
    #define DEFAULT_Ki   0.78 //MODIFICATO
    #define DEFAULT_Kd  51.40 //MODIFICATO
  #endif
#else
...
#define PIDTEMPBED //MODIFICATO
  ...
  #define DEFAULT_bedKp 17.12 //MODIFICATO
  #define DEFAULT_bedKi 2.81 //MODIFICATO
  #define DEFAULT_bedKd 69.53 //MODIFICATO
...
#define X_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. MODIFICATO
#define Y_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. MODIFICATO 
#define Z_MIN_ENDSTOP_INVERTING true // Set to true to invert the logic of the endstop. MODIFICATO
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 80, 80, 400, 410 } //MODIFICATO 
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_FEEDRATE          { 300, 300, 100, 45 } //MODIFICATO 
 ...
 *                                      X, Y, Z [, I [, J [, K...]]], E0 [, E1[, E2...]]
 */
#define DEFAULT_MAX_ACCELERATION      { 1500, 1500, 100, 5000 } //MODIFICATO 
 ...
 */
#define DEFAULT_ACCELERATION          1200    // X, Y, Z and E acceleration for printing moves MODIFICATO DA 3000
...
#define DEFAULT_EJERK    7.0  // May be used by Linear Advance MODIFICATO
...
#define USE_PROBE_FOR_Z_HOMING //MODIFICATO 
 ...
 */
#define Z_MIN_PROBE_PIN PC4 //MODIFICATO 
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { 38, 0, -1.5 } //MODIFICATO 
 ...
 */
#define MULTIPLE_PROBING 2 //MODIFICATO, uncommented
#define EXTRA_PROBING    1 //MODIFICATO, uncommented
 ...
 */
#define Z_CLEARANCE_DEPLOY_PROBE   7 // (mm) Z Clearance for Deploy/Stow MODIFICATO DA 10
#define Z_CLEARANCE_BETWEEN_PROBES  5 // (mm) Z Clearance between probe points
#define Z_CLEARANCE_MULTI_PROBE     3 // (mm) Z Clearance between multiple probes MODIFICATO 5
//#define Z_AFTER_PROBING           5 // (mm) Z position after probing is done

#define Z_PROBE_LOW_POINT          -10 // (mm) Farthest distance below the trigger-point to go before stopping MODIFICATO DA -2

// For M851 give a range for adjusting the Z probe offset
#define Z_PROBE_OFFSET_RANGE_MIN -50 //MODIFICATO DA -20
#define Z_PROBE_OFFSET_RANGE_MAX 50 //MODIFICATO DA 20
...
#define INVERT_X_DIR false //MODIFICATO 
#define INVERT_Y_DIR false //MODIFICATO
#define INVERT_Z_DIR true //MODIFICATO
...
#define INVERT_E0_DIR true //MODIFICATO
...
#define HOME_AFTER_DEACTIVATE   // Require rehoming after steppers are deactivated. Also enable NO_MOTION_BEFORE_HOMING for extra safety. MODIFICATO, uncommented 
...
#define X_BED_SIZE 245 //MODIFICATO 
#define Y_BED_SIZE 200 //MODIFICATO 
...
#define Z_MAX_POS 205 //MODIFICATO 
//#define I_MIN_POS 0
//#define I_MAX_POS 50
//#define J_MIN_POS 0
//#define J_MAX_POS 50
 ...
 */
//#define FILAMENT_RUNOUT_SENSOR //MODIFICATO uncommented (commentato perchè non funziona)
#if ENABLED(FILAMENT_RUNOUT_SENSOR)
  #define FIL_RUNOUT_ENABLED_DEFAULT true // Enable the sensor on startup. Override with M412 followed by M500.
  #define NUM_RUNOUT_SENSORS   1          // Number of sensors, up to one per extruder. Define a FIL_RUNOUT#_PIN for each.

  #define FIL_RUNOUT_STATE     LOW        // Pin state indicating that filament is NOT present.  
  //#define FIL_RUNOUT_PULLUP               // Use internal pullup for filament runout pins. MODIFICATO, commented 
...
#define AUTO_BED_LEVELING_UBL //MODIFICATO 
 ...
 */
#define RESTORE_LEVELING_AFTER_G28 //MODIFICATO 
...
//#define DEBUG_LEVELING_FEATURE
   ...
   */
  #define G26_MESH_VALIDATION //MODIFICATO 
  ...
  #define UBL_HILBERT_CURVE       // Use Hilbert distribution for less travel when probing multiple points MODIFICATO, uncommented 
 ...
 */
#define EEPROM_SETTINGS     // Persistent storage with M500 and M501 MODIFICATO, uncommented 
 ...
 */
#define NOZZLE_PARK_FEATURE //MODIFICATO, uncommented  
 ...
 */
#define SDSUPPORT //MODIFICATO, uncommented 
 ...
 */
#define SD_CHECK_AND_RETRY //MODIFICATO, uncommented 
...
//
#define INDIVIDUAL_AXIS_HOMING_MENU //MODIFICATO, uncommented 
...
// Usually paired with MKS Robin Nano V1.2
//
#define MKS_ROBIN_TFT35 //MODIFICATO, uncommented 
...
//#define TFT_COLOR_UI
#define TFT_LVGL_UI //MODIFICATO, uncommented 
  ...
  #define MKS_WIFI_MODULE // MKS WiFi module MODIFICATO, uncommented 
#endif
...
//
#define TOUCH_SCREEN //MODIFICATO, uncommented 
